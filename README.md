...
<img src="https://skillicons.dev/icons?i=react,nextjs,ts,js,vite,redux,tailwind,threejs,sass,bootstrap&theme=dark" alt="frontend" />
...
<img src="https://skillicons.dev/icons?i=docker,githubactions,git,github,gitlab,aws,vercel,netlify,linux,bash&theme=dark" alt="devops and cloud" />

Docker, GitHub Actions, AWS (S3, SQS, Bedrock), Vercel, Hugging Face, CI/CD

**AI and Machine Learning**

<img src="https://skillicons.dev/icons?i=pytorch,tensorflow,sklearn,opencv,anaconda&theme=dark" alt="ai and machine learning" />
...
PyTorch, TensorFlow and Keras, scikit-learn, OpenCV, on device TFLite, transfer learning, Grad-CAM explainability, image enhancement (Real-ESRGAN and GFPGAN), NLP with finite state transducers, embeddings, LLM integration and prompt engineering (Gemini, AWS Bedrock)
...
A few public ones, mostly AI and computer vision. Click through if you want to see the code and the stack.
